          ...
          {courses.length > 0 ? (
            <>
              ...
              <div className="home__manager">
                <Link className="home__manager-stu" to="/students"> <Button >Manage Students</Button></Link>
                <Link className="home__manager-cla" to="/classes"><Button >Manage Classes</Button></Link>
                <Link className="home__manager-cou" to="/courses"><Button >Manage Courses</Button></Link>
              </div>
            </>
          ) : (
            <div>
